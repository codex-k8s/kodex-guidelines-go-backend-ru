...
- Метрики насыщения обязательны для сервисов с внешним трафиком или фоновой обработкой:
  in-flight операции, заполнение очередей/буферов, отказы из-за лимитов, использование пулов БД/кэша,
  количество активных worker goroutines и задержка ожидания ресурсов.
