...
Этот репозиторий содержит инженерные правила для Go backend в проектах `kodex`.
...
- Ссылки на общие правила держать через публичный репозиторий `kodex-guidelines-common-ru`.
