...
Список согласованных внешних библиотек и инструментов, если он нужен проекту, должен вестись локально в самом проекте или в его собственном пакете правил.
