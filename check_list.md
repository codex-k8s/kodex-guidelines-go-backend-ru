...
## Webhook и процессы
- Если проект использует webhook/event-driven модель, она зафиксирована явно и не размыта неявной workflow-first зависимостью.
...
- Если в проекте ведётся каталог внешних зависимостей, он обновлён при изменении состава библиотек.
